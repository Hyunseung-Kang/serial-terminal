...
saving_radio.set(1)
radio1_func()
button_saving1 = tk.Radiobutton(root, text="Saving a Single Response", value=1, variable=saving_radio, command=radio1_func)
button_saving1.place(x=20, y=120)
button_saving2 = tk.Radiobutton(root, text="Saving Cyclical Response", value=2, variable=saving_radio, command=radio2_func)
button_saving2.place(x=20, y=140)
button_saving3 = tk.Radiobutton(root, text="Non-Saving", value=3, variable=saving_radio, command=radio3_func)
...
#Example1 - "show network summary"
button_tutorials = Button(root,text="network-summary",width=20,command=SendingExample)
button_tutorials.config(font="bold")
button_tutorials.place(x=700, y=30)
